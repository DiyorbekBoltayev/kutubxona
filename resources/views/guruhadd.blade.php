...
@section('content')
    <div class="container">
        ...
        <form action="{{route('saqla_gr')}}" method="post">
            <div class="form-floating mb-3">
                <input type="text" name="guruh" class="form-control" id="mahalliy_id" autocomplete="off"   required  placeholder="name@example.com">
