    ...
    <div class="container">
        ...
        <form action="{{route('save_edit')}}" method="post">
            ...
            <div class="form-floating mb-3">
                <input type="number" name="mahalliy_id" value="{{$book->local_id}}" class="form-control" id="mahalliy_id" autocomplete="off"   required  placeholder="name@example.com">
                <label for="mahalliy_id">Mahalliy raqami</label>
                <div id="mahalliyidlist" > </div>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="sarlavha" class="form-control" value="{{$book->sarlavha->sarlavha}}" id="sarlavha" autocomplete="off"   required  placeholder="name@example.com">
                <label for="sarlavha">Sarlavha</label>
                <div id="sarlavhalist" > </div>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="muallif" class="form-control" value="{{$book->muallif->muallif}}" id="muallif"  autocomplete="off"   required placeholder="name@example.com">
                <label for="muallif">Muallif</label>
                <div id="mualliflist" > </div>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="kitob_turi" class="form-control" value="{{$book->turi->kitob_turi}}" id="kitob_turi"  autocomplete="off"   required placeholder="name@example.com">
                <label for="kitob_turi">Kitob turi</label>
                <div id="kitob_turilist" > </div>
            </div>
            <div class="form-floating mb-3">
                <input type="number" name="nashr_yili" class="form-control" value="{{$book->yili}}" id="nashr_yili" autocomplete="off"    required  placeholder="name@example.com">
                <label for="nashr_yili">Nashr qilingan yili </label>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="nashriyot" class="form-control" value="{{$book->nashriyot->nashriyot}}" id="nashriyot"  autocomplete="off"  required  placeholder="name@example.com">
                <label for="nashriyot">Nashriyot</label>
                <div id="nashriyotlist" > </div>
            </div>
            <div class="form-floating mb-3">
                <input type="text" name="javon" class="form-control" id="javon" value="{{$book->javon->javon}}"  autocomplete="off"  required  placeholder="name@example.com">
